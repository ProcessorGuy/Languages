...
def assignTasks(listOfHex, uavs, polyMain, lfps):
    ...
    # shuffle list      
    random.shuffle(listOfHex)
    
    # sort list according to priorities
    listOfHexSorted = listOfHex
   ...
   # generate colors
    ...
    def initPlot():
        for ii, poly in enumerate(listOfHexSorted):
            ...
            plt.annotate(poly.number,xy=(x1, y1))   
    ...
    # Save the animation        
    anim.save('Algorithm3.gif', writer='PillowWriter', fps=lfps)        
